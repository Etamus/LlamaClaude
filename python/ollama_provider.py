...
ollama_provider.py
------------------
DEPRECATED: Ollama support has been replaced by llama.cpp (llama-server).
...
"""
# Re-export llama.cpp provider under the old Ollama names for compatibility
from llamacpp_provider import (
    check_llamacpp_running as check_ollama_running,
    list_llamacpp_models as list_ollama_models,
    llamacpp_chat as ollama_chat,
    llamacpp_chat_stream as ollama_chat_stream,
)
