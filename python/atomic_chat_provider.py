...
-----------------------
DEPRECATED: Atomic Chat support has been replaced by llama.cpp (llama-server).
This module is kept for backwards-compatibility only and re-exports
everything from llamacpp_provider.

Use llamacpp_provider directly or configure via:
    CLAUDE_CODE_USE_OPENAI=1
    OPENAI_BASE_URL=http://localhost:8080/v1
"""
# Re-export llama.cpp provider under the old Atomic Chat names for compatibility
from llamacpp_provider import (
    check_llamacpp_running as check_atomic_chat_running,
    list_llamacpp_models as list_atomic_chat_models,
    llamacpp_chat as atomic_chat,
    llamacpp_chat_stream as atomic_chat_stream,
)
